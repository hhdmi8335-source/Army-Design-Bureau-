  ...
  "detections": [
    {
      ...
      "speed": "string - estimated speed if moving, e.g. 45 km/h",
      "armor_type": "string - estimated armor type, e.g. Composite, Reactive, None",
      "country_of_origin": "string - suspected country of origin",
      "tracking_id": "string - unique ID for this object in the scene, e.g. V-001",
