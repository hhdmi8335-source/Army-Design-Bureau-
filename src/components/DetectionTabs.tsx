...
import { Crosshair, Image as ImageIcon, Radio } from "lucide-react";
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-7xl mx-auto">
          <Tabs defaultValue="image" className="w-full">
            <TabsList className="grid w-full max-w-xl mx-auto grid-cols-2 mb-8 h-12 bg-tactical-dark border border-border">
              <TabsTrigger
                value="image"
